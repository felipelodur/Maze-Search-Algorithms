...
function initaliseSearchExample(rows, cols) {
    ...
    pathfinder = new AStar(gamemap, start, end, allowDiagonals);
    selectedAlgorithm = "A*";
}
...
function setup() {
    ...
    runGreedyButton = new Button("Greedy", 430, 220, 50, 30, greedy);
    runUniformButton = new Button("Uniform", 430, 250, 50, 30, uniform);
...
function draw() {
    ...
    text("by Felipe Coelho and Daniel Gunna", 10, 550);
    startTime();
